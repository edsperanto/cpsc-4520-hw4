...
CFLAGS += -I ./list
LIST_TARGETS = ./list/list.c
LIST_OBJECTS = $(LIST_TARGETS:%.c=%.o)
...
AIRPORTS_OBJECTS = $(AIRPORTS_OBJECTS_SVC) $(LIST_OBJECTS) $(KD_OBJECTS)
...
clean:
	$(RM) core $(CLIENT_OBJECTS) $(PLACES_OBJECTS) $(AIRPORTS_OBJECTS) $(LIST_OBJECTS) $(TRIE_OBJECTS) $(KD_OBJECTS) $(CLIENT) $(PLACES) $(AIRPORTS)
